...
+ (YSITunesTrack *) trackFromDictionary:(NSDictionary *)trackDict
{
    ...
    track.awsAlbumImageUrl = trackDict[@"aws_image_url"] != nil && trackDict[@"aws_image_url"] != [NSNull null] ? trackDict[@"aws_image_url"] : nil;
    track.awsAlbumImageEtag = trackDict[@"aws_image_etag"] != nil && trackDict[@"aws_image_etag"] != [NSNull null] ? trackDict[@"aws_image_etag"] : nil;
