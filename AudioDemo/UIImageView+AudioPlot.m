...
//
//  UIImageView+AudioPlot.m
//  YapTap
//
//  Created by Rudd Taylor on 9/4/15.
...
@implementation UIImageView (AudioPlot)
...
+ (UIImageView *)imageViewWithAudioUrl:(NSURL *)url {
    UIImageView *image = UIImageView.new;
    AVURLAsset *urlA = [AVURLAsset URLAssetWithURL:url options:nil];
    [image setImage:[UIImage imageWithData:[image renderPNGAudioPictogramLogForAssett:urlA]]];
    return image;
}
